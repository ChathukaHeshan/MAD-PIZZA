package com.example.mad_pizza.CustomerFoodPanel;
...
import com.example.mad_pizza.CustomerFoodPanel_BottomNavigation;
import com.example.mad_pizza.R;
import com.example.mad_pizza.SendNotification.APIService;
import com.example.mad_pizza.SendNotification.Client;
import com.example.mad_pizza.SendNotification.Data;
import com.example.mad_pizza.SendNotification.MyResponse;
import com.example.mad_pizza.SendNotification.NotificationSender;
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        data.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                FirebaseDatabase.getInstance().getReference("CustomerFinalOrders").child(FirebaseAuth.getInstance().getCurrentUser().
                                        getUid()).child(RandomUID).child("OtherInformation").setValue(hashMap1).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
